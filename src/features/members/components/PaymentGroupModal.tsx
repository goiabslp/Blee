    ...
    <Modal 
      ...
      subHeader={
        <div className="space-y-4">
          ...
          <div className="rounded-2xl bg-emerald-50 p-4 shadow-sm border border-emerald-100">
      ...
      footer={
        <Button onClick={onClose} className={`w-full ${themeBg} ${themeShadow} py-4 text-sm font-bold`}>
          Fechar
        </Button>
      }
    >
      <div className="space-y-4">
        ...
        <div className="space-y-3 pb-2">
          {group.items.map((item: any, idx: number) => {
            ...
            return (
              <div key={idx} className="flex flex-col gap-2 rounded-2xl border border-slate-100 p-3 bg-white">
